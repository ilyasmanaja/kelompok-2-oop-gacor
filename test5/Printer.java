...
public class Printer {
    ...
    public void tampilkanInfoPrinter() {
        System.out.println("Merk printer ini adalah: " + merk 
        + "dan printer ini memiliki warna: " + warna);
    }
    
    //METHOD 2 (OVERLOADING)
    public void tampilkanInfoPrinter(int tahun) {
        System.out.println("Printer ini bermerk " + merk 
        + "dan berwarna " + warna + "lalu di rilis "+ "pada tahun " + tahun);
    } 
}
